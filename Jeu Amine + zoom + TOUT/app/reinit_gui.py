...
class ReinitGUI(GUI):
    def __init__(self, game):
        ...
        self.nibMapWidth = NumberInputBox(self, x=150, y=200, caption="Map Width", minVal=17, maxVal=512)
        self.nibMapHeight = NumberInputBox(self, x=400, y=200, caption="Map Height", minVal=17, maxVal=512)
